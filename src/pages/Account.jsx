...
const Account = () => {
  ...
  const handleSaveProfile = (e) => {
    e.preventDefault();
    localStorage.setItem('vive_user_profile', JSON.stringify(profileData));
    setSaveSuccess(true);
    setTimeout(() => {
            ...
            <div className="bg-white rounded-3xl border border-gray-100 p-6 shadow-[0_10px_30px_rgba(0,0,0,0.01)] space-y-4 text-left">
              ...
              {wishlist.length === 0 ? (
                ...
                <div className="space-y-3.5 pt-1">
                  ...
                  {wishlist.length > 3 && (
                    <Link to="/wishlist" className="text-[10px] font-bold uppercase tracking-wider text-brand-magenta hover:underline block pt-1">
